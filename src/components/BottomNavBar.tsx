...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-2 pb-3 pt-1.5 bg-[#0D0F16]/95 backdrop-blur-md border-t border-[#2A2D35] md:hidden shadow-[0_-4px_16px_rgba(0,0,0,0.6)]">
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            <div
              className={`flex flex-col items-center justify-center rounded-xl px-4 py-1 mb-0.5 transition-all duration-150 group-active:scale-90 ${
                isActive
